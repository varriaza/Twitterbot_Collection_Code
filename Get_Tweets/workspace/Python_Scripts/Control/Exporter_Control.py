...
def main(argv):
	...
	try:
		...
		tweetCriteria = got_Control.manager.TweetCriteria()
		...
		os.chdir("/home/ubuntu/workspace/data/Control_data/Term_tweets")
		...
		got_Control.manager.TweetManager_Control.getTweets(tweetCriteria, receiveBuffer)
