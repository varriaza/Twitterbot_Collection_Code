...
def main(argv):
	...
	try:
		...
		tweetCriteria = got_Interactor.manager.TweetCriteria()
		...
		got_Interactor.manager.TweetManager_Interactor.getTweets(tweetCriteria, receiveBuffer)
